...
const Testimonials = () => {
  return (
    <div className='bg-[#16202f] h-fit flex flex-col pt-32 items-center  gap-24 text-white '>
        
        <div className='text-5xl font-bold'>What do our <span className='text-[#039be5]'>clients</span> say about us? </div>
        <div className='text-2xl items-center flex flex-col gap-2 '>
